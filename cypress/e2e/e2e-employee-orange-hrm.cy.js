...
describe('Automation UI test e2e di Orange HRM',() => {
    ...
    context('Admin feature', () => {
        ...
        beforeEach(() => {
         ...
         it.skip("Possitive Case - Buat Akun untuk Karyawan Baru dengan data valid", () => {
         ...
         it("Negative Case - Buat Akun untuk Karyawan Baru dengan data empty", () => {
            cy.xpath(xpathPasswordAddUsr).click().clear();
            cy.xpath(xpathUsernameAddUsr).click().clear();
            cy.xpath(xpathConfPasswordAddUsr).click().clear();
            cy.xpath(xpathSaveButtonAddUsr).click();
